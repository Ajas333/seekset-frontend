  ...
  return (
    ...
    >
      <div className="bg-blue-100 md:bg-white rounded-lg md:rounded-tr-4xl md:rounded-bl-4xl h-auto w-4/5  md:w-3/5 flex">
        {!isSpinner && (
          <>
            <div className="content hidden md:block bg-gradient-to-br from-blue-100 to-blue-400 w-2/4 rounded-bl-4xl p-8 relative">
                  ...
                  {isSignup ? (
                    <p className="text-gray-700">
                      ...
                      <span
                        ...
                        className="underline text-blue-600 hover:text-blue-800 transition duration-200 cursor-pointer"
                      >
                        LogIn now
                      </span>
                    </p>
            ...
            <div className="inputs  md:w-2/4  p-8 rounded-md md:rounded-tr-4xl">
              ...
              <div>
                ...
                {isSignup && !isEmployer && (
                  <CandidateSignin setIsSpinner={setIsSpinner} />
                )}
                {isSignup && isEmployer && (
                  <EmpSignup setIsSpinner={setIsSpinner} />
                )}
              </div>
              <div
